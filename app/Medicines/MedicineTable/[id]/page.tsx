...
function formatDisplayDate(value: string): string {
    ...
    const yearFirst = first > 1000;
    const year = yearFirst ? first : third;
    const firstPart = yearFirst ? second : first;
    const secondPart = yearFirst ? third : second;

    // Dates generated by the app are day-first when both parts are <= 12.
    const day = firstPart > 12 ? firstPart : secondPart > 12 ? secondPart : firstPart;
    const month = firstPart > 12 ? secondPart : secondPart > 12 ? firstPart : secondPart;
